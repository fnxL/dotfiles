...
send_notification() {
    if >/dev/null 2>&1 command -v notify-send ; then
        if [[ "${store}" == "save" ]] ; then
            ...
            dunstify -h string:fgcolor:#3D4059 '      ' -i ~/.config/dunst/icons/screenshot.svg   "<span foreground='#e06c75' font_desc='Cartograph CF Italic 19'><b>Scr</b></span><span foreground='#e5c07b' font_desc='Cartograph CF Italic 19'><b>eens</b></span><span foreground='#98c379' font_desc='Cartograph CF Italic 19'><b>hot</b></span> \n<span foreground='#abb2bf' font_desc='Cartograph CF 13'><b>Screenshot saved!</b></span>"
        elif [[ "${store}" == "clip" ]] ; then
            #dunstify -h string:fgcolor:#2c2e3e '      ' -i ~/.config/dunst/icons/clipboard.svg 'Screenshot passed to clipboard!'
            dunstify -h string:fgcolor:#3D4059 '      ' -i ~/.config/dunst/icons/clipboard.svg   "<span foreground='#ebb9b9' font_desc='Cartograph CF Italic 19'><b>Scr</b></span><span foreground='#ebe3b9' font_desc='Cartograph CF Italic 19'><b>eens</b></span><span foreground='#caf6bb' font_desc='Cartograph CF Italic 19'><b>hot</b></span> \n<span foreground='#cddbf9' font_desc='Cartograph CF 13'><b>Passed to clipboard!</b></span>"
        fi
    fi
}
